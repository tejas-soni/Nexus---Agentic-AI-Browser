...
exports.SelectorType = exports.PSEUDO_DIRECTIVES = exports.PSEUDO_ELEMENTS = exports.PSEUDO_CLASSES = exports.EXTENDED_PSEUDO_CLASSES = void 0;
exports.classifySelector = classifySelector;
exports.destructAST = destructAST;
exports.indexOfPseudoDirective = indexOfPseudoDirective;
...
exports.PSEUDO_DIRECTIVES = new Set(['remove', 'remove-attr', 'remove-class']);
var SelectorType;
...
function classifySelector(selector) {
    ...
    for (const token of tokens) {
        if (token.type === 'pseudo-class') {
            const { name } = token;
            if (exports.EXTENDED_PSEUDO_CLASSES.has(name) === true || exports.PSEUDO_DIRECTIVES.has(name) === true) {
                foundSupportedExtendedSelector = true;
            }
            else if (exports.PSEUDO_CLASSES.has(name) === false &&
                exports.PSEUDO_ELEMENTS.has(name) === false
...
function destructAST(ast) {
    ...
    if (ast.type === 'compound') {
        ...
        if (last.type === 'pseudo-class' && exports.PSEUDO_DIRECTIVES.has(last.name)) {
...
function indexOfPseudoDirective(selector) {
    ...
    if (exports.PSEUDO_DIRECTIVES.has(selector.slice(c + 1, i))) {
        return c;
    }
    return -1;
}
