...
exports.NETWORK_FILTER_OPTIONAL_PARTS_MASK = exports.NETWORK_FILTER_MASK = void 0;
...
})(NETWORK_FILTER_OPTIONAL_PARTS_MASK || (exports.NETWORK_FILTER_OPTIONAL_PARTS_MASK = NETWORK_FILTER_OPTIONAL_PARTS_MASK = {}));
/**
...
class NetworkFilter {
    ...
    static deserialize(buffer) {
        ...
        return new NetworkFilter({
            ...
            mask,
            // Optional parts
            filter: (0, utils_js_1.getBit)(optionalParts, NETWORK_FILTER_OPTIONAL_PARTS_MASK.hasFilter)
                ? isUnicode
                    ? buffer.getUTF8()
                    : buffer.getNetworkFilter()
                : undefined,
            hostname: (0, utils_js_1.getBit)(optionalParts, NETWORK_FILTER_OPTIONAL_PARTS_MASK.hasHostname)
                ? buffer.getNetworkHostname()
                : undefined,
            domains: (0, utils_js_1.getBit)(optionalParts, NETWORK_FILTER_OPTIONAL_PARTS_MASK.hasDomains)
                ? domains_js_1.Domains.deserialize(buffer)
                : undefined,
            rawLine: (0, utils_js_1.getBit)(optionalParts, NETWORK_FILTER_OPTIONAL_PARTS_MASK.hasRawLine)
                ? buffer.getRawNetwork()
                : undefined,
            denyallow: (0, utils_js_1.getBit)(optionalParts, NETWORK_FILTER_OPTIONAL_PARTS_MASK.hasDenyallow)
                ? domains_js_1.Domains.deserialize(buffer)
                : undefined,
            optionValue: (0, utils_js_1.getBit)(optionalParts, NETWORK_FILTER_OPTIONAL_PARTS_MASK.hasOptionValue)
                ...
                : undefined,
            regex: undefined,
            isCaseSensitive: (0, utils_js_1.getBit)(optionalParts, NETWORK_FILTER_OPTIONAL_PARTS_MASK.isCaseSensitive),
        });
    }
    ...
    serialize(buffer) {
        ...
        if (this.filter !== undefined) {
            optionalParts = (0, utils_js_1.setBit)(optionalParts, NETWORK_FILTER_OPTIONAL_PARTS_MASK.hasFilter);
            if (this.isUnicode()) {
        ...
        if (this.hostname !== undefined) {
            optionalParts = (0, utils_js_1.setBit)(optionalParts, NETWORK_FILTER_OPTIONAL_PARTS_MASK.hasHostname);
            buffer.pushNetworkHostname(this.hostname);
        }
        if (this.domains !== undefined) {
            optionalParts = (0, utils_js_1.setBit)(optionalParts, NETWORK_FILTER_OPTIONAL_PARTS_MASK.hasDomains);
            this.domains.serialize(buffer);
        }
        if (this.rawLine !== undefined) {
            optionalParts = (0, utils_js_1.setBit)(optionalParts, NETWORK_FILTER_OPTIONAL_PARTS_MASK.hasRawLine);
            buffer.pushRawNetwork(this.rawLine);
        }
        if (this.denyallow !== undefined) {
            optionalParts = (0, utils_js_1.setBit)(optionalParts, NETWORK_FILTER_OPTIONAL_PARTS_MASK.hasDenyallow);
            this.denyallow.serialize(buffer);
        }
        if (this.optionValue !== undefined) {
            optionalParts = (0, utils_js_1.setBit)(optionalParts, NETWORK_FILTER_OPTIONAL_PARTS_MASK.hasOptionValue);
            if (this.isCSP()) {
        ...
        if (this.isCaseSensitive) {
            optionalParts = (0, utils_js_1.setBit)(optionalParts, NETWORK_FILTER_OPTIONAL_PARTS_MASK.isCaseSensitive);
        }
