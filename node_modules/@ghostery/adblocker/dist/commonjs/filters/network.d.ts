...
export declare const enum NETWORK_FILTER_OPTIONAL_PARTS_MASK {
    hasFilter = 1,
    hasHostname = 2,
    hasDomains = 4,
    hasRawLine = 8,
...
export default class NetworkFilter implements IFilter {
    ...
    constructor({ filter, hostname, mask, domains, denyallow, optionValue, rawLine, regex, isCaseSensitive, }: {
