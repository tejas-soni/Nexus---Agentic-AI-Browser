 ...
 */
import { AST, PseudoClass } from '@ghostery/adblocker-extended-selectors';
...
export default class CosmeticFilter implements IFilter {
    ...
    readonly parentDomains: Domains | undefined;
     ...
     */
    toString(): string;
    match(hostname: string, domain: string, ancestors?: {
        hostname: string;
        domain: string;
    }[]): boolean;
    /**
