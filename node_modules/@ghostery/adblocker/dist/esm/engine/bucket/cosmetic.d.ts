...
export default class CosmeticFilterBucket {
     ...
     */
    getCosmeticsFilters({ domain, hostname, ancestors, classes, hrefs, ids, allowGenericHides, allowSpecificHides, getRulesFromDOM, getRulesFromHostname, isFilterExcluded, }: {
        domain: string;
        hostname: string;
        ancestors?: {
            domain: string;
